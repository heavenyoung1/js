    ...
    if request.method == 'GET':
        ...
        if request.POST['password1'] == request.POST['password2']:
            try:
                ...
                return render(request, 'todo/signupuser.html', {'form': UserCreationForm(), 'error': 'Этот логин уже занят'})
        else:
...
def viewtodo(request, todo_pk):
    ...
    if request.method == 'GET':
        ...
        try:
            ...
            return render(request, 'todo/viewtodo.html', {'todo':todo, 'form': TodoForm(), 'error': 'Переданы неверные данные'})
